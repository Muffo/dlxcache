...
\begin{itemize}
\item \texttt{}portare \texttt{ch\_hit="1" e ch\_hitm="1"}
\item \texttt{}forzare la scrittura in RAM del blocco contenuto in cache
\item \texttt{}portare lo stato della via in MESI\_S("1")
\end{itemize}
