...
\usepackage{atbeginend} % per modificare proprietà allinizio e fine degli envirorments 
...
\title{Progetto di servizi sicuri con tecnologia Web Service nel settore della didattica}
\author{Ilias Bartolini}
\date{}
\titolocorso{Ingegneria Informatica}
\nomemateria{Reti di Calcolatori}
\degreeyear{2003/2004}					% Anno Accademico di Laurea
