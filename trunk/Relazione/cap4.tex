...
\end{lstlisting} 
Questo codice conta fino a tre (da qui il nome del file termina con 123), e ad ogni iterazione ricomincia da uno, inoltre ogni risultato intermedio viene salvato in memoria in una locazione diversa in modo da obbligare la cache, ad ogni iterazione, a rimpiazzare un blocco, lavorando sempre nel primo set (per un  numero limitato d'iterazioni). Infatti, ad esempio nella prima iterazione, quando r1="0",si nota che i due bit che identificano l'indice sono sempre uguali a "00":\\
